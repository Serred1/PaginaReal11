            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../encuestas/Estudiante/quiz1.php">Encuesta Video 1</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../inicio/estudiante/foro.php">Foro</a>
                    </div>
                </div>
            </li>
...
<h3>MODALIDAD</h3><img src="../img/golpe.png" alt="" class="icono4">
 <p>MIXTA</p>
 <br>
...
<p>- Dudas y consultas a través del foro.</p>

<p>- Plazo desde el 17 de Octubre al 14 de Noviembre.</p>
